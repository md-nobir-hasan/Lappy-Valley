                        ...
                        e = {
                            ...
                            generateHTML: function(a) {
                                ...
                                if (
                                    ...
                                    g &&
                                        C &&
                                        (x += `<div class="${y}-nav J-paginationjs-nav">${(e = t.replaceVariables(
                                            C,
                                            {
                                                currentPage: o,
                                                totalPage: i,
                                    ...
                                    (l || u || c) &&
                                        ...
                                        l &&
                                            (o <= 1
                                                ...
                                                : (x += `<li class="${y}-prev J-paginationjs-previous ${k}" data-num="${o -
                                                      1}" title="Previous page">${n(
                                                      b
                                                  )}</li>`)),
                                        u &&
                                        ...
                                        c &&
                                            (i <= o
                                                ...
                                                : (x += `<li class="${y}-next J-paginationjs-next ${P}" data-num="${o +
                                                      1}" title="Next page">${n(
                                                      h
                                                  )}</li>`)),
                                        (x += "</ul></div>")),
                                ...
                                return (
                                    ...
                                    m &&
                                        w &&
                                        (x += `<div class="${y}-go-button">${(e = t.replaceVariables(
                                            w,
                                            {
                                                currentPage: o,
                                                totalPage: i,
                            ...
                            findTotalNumberFromRemoteResponse: function(a) {
                                this.model.totalNumber = J.totalNumberLocator(
                                    a
                                );
                            },
                            go: function(a, t) {
                            ...
                            parseDataSource: function(a, e) {
                                ...
                                D.isObject(a)
                                    ? e(
                                          (J.dataSource = t.filterDataWithLocator(
                                              a
                                          ))
                                      )
                                    : D.isArray(a)
                        ...
                        if ("string" == typeof a) {
                            ...
                            switch (((o[0] = s + o[0]), a)) {
                                ...
                                case "getCurrentPageNum":
                                    return (c.data("pagination").model
