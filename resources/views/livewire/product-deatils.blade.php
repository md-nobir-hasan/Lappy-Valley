<div
    ...
    <div class="mt-[30px] grid grid-cols-2 items-center max-md:grid-cols-1">
        ...
        <div class="text-left max-md:mt-[40px]">
            <div>
                <h1 class="font-[jost] text-[22px] font-[500] text-[#380D37] max-lg:text-[22px]">
                    {{ $product->title }}
                </h1>
            </div>
            <div class="flex text-center gap-[4px] mt-2">
                <span>
                    <svg viewBox="0 0 24 24" fill="#72bf44" class="w-[20px] h-[20px]" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.245 4.174C11.4765 3.50808 11.5922 3.17513 11.7634 3.08285C11.9115 3.00298 12.0898 3.00298 12.238 3.08285C12.4091 3.17513 12.5248 3.50808 12.7563 4.174L14.2866 8.57639C14.3525 8.76592 14.3854 8.86068 14.4448 8.93125C14.4972 8.99359 14.5641 9.04218 14.6396 9.07278C14.725 9.10743 14.8253 9.10947 15.0259 9.11356L19.6857 9.20852C20.3906 9.22288 20.743 9.23007 20.8837 9.36432C21.0054 9.48051 21.0605 9.65014 21.0303 9.81569C20.9955 10.007 20.7146 10.2199 20.1528 10.6459L16.4387 13.4616C16.2788 13.5829 16.1989 13.6435 16.1501 13.7217C16.107 13.7909 16.0815 13.8695 16.0757 13.9507C16.0692 14.0427 16.0982 14.1387 16.1563 14.3308L17.506 18.7919C17.7101 19.4667 17.8122 19.8041 17.728 19.9793C17.6551 20.131 17.5108 20.2358 17.344 20.2583C17.1513 20.2842 16.862 20.0829 16.2833 19.6802L12.4576 17.0181C12.2929 16.9035 12.2106 16.8462 12.1211 16.8239C12.042 16.8043 11.9593 16.8043 11.8803 16.8239C11.7908 16.8462 11.7084 16.9035 11.5437 17.0181L7.71805 19.6802C7.13937 20.0829 6.85003 20.2842 6.65733 20.2583C6.49056 20.2358 6.34626 20.131 6.27337 19.9793C6.18915 19.8041 6.29123 19.4667 6.49538 18.7919L7.84503 14.3308C7.90313 14.1387 7.93218 14.0427 7.92564 13.9507C7.91986 13.8695 7.89432 13.7909 7.85123 13.7217C7.80246 13.6435 7.72251 13.5829 7.56262 13.4616L3.84858 10.6459C3.28678 10.2199 3.00588 10.007 2.97101 9.81569C2.94082 9.65014 2.99594 9.48051 3.11767 9.36432C3.25831 9.23007 3.61074 9.22289 4.31559 9.20852L8.9754 9.11356C9.176 9.10947 9.27631 9.10743 9.36177 9.07278C9.43726 9.04218 9.50414 8.99359 9.55657 8.93125C9.61593 8.86068 9.64887 8.76592 9.71475 8.57639L11.245 4.174Z" stroke="#72bf44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                </span>
                <span>
                    <svg viewBox="0 0 24 24" fill="#72bf44" class="w-[20px] h-[20px]" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M11.245 4.174C11.4765 3.50808 11.5922 3.17513 11.7634 3.08285C11.9115 3.00298 12.0898 3.00298 12.238 3.08285C12.4091 3.17513 12.5248 3.50808 12.7563 4.174L14.2866 8.57639C14.3525 8.76592 14.3854 8.86068 14.4448 8.93125C14.4972 8.99359 14.5641 9.04218 14.6396 9.07278C14.725 9.10743 14.8253 9.10947 15.0259 9.11356L19.6857 9.20852C20.3906 9.22288 20.743 9.23007 20.8837 9.36432C21.0054 9.48051 21.0605 9.65014 21.0303 9.81569C20.9955 10.007 20.7146 10.2199 20.1528 10.6459L16.4387 13.4616C16.2788 13.5829 16.1989 13.6435 16.1501 13.7217C16.107 13.7909 16.0815 13.8695 16.0757 13.9507C16.0692 14.0427 16.0982 14.1387 16.1563 14.3308L17.506 18.7919C17.7101 19.4667 17.8122 19.8041 17.728 19.9793C17.6551 20.131 17.5108 20.2358 17.344 20.2583C17.1513 20.2842 16.862 20.0829 16.2833 19.6802L12.4576 17.0181C12.2929 16.9035 12.2106 16.8462 12.1211 16.8239C12.042 16.8043 11.9593 16.8043 11.8803 16.8239C11.7908 16.8462 11.7084 16.9035 11.5437 17.0181L7.71805 19.6802C7.13937 20.0829 6.85003 20.2842 6.65733 20.2583C6.49056 20.2358 6.34626 20.131 6.27337 19.9793C6.18915 19.8041 6.29123 19.4667 6.49538 18.7919L7.84503 14.3308C7.90313 14.1387 7.93218 14.0427 7.92564 13.9507C7.91986 13.8695 7.89432 13.7909 7.85123 13.7217C7.80246 13.6435 7.72251 13.5829 7.56262 13.4616L3.84858 10.6459C3.28678 10.2199 3.00588 10.007 2.97101 9.81569C2.94082 9.65014 2.99594 9.48051 3.11767 9.36432C3.25831 9.23007 3.61074 9.22289 4.31559 9.20852L8.9754 9.11356C9.176 9.10947 9.27631 9.10743 9.36177 9.07278C9.43726 9.04218 9.50414 8.99359 9.55657 8.93125C9.61593 8.86068 9.64887 8.76592 9.71475 8.57639L11.245 4.174Z" stroke="#72bf44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                </span>
                ...
                <span>
                    <a href="" class="text-[12px] text-[#000000] hover:text-[#919191] text-center decoration-none duration-200">
                        10 reviews 
                    </a>
                </span>
            </div>
            <ul class="mb-3 mt-4 leading-[29px] max-lg:leading-[26px]">
                ...
                <li class="mt-[14px] font-[jost] text-[18px] font-[500] text-[#353535] max-lg:text-[18px]">
                    Regular Price:</li>
                ...
                @endif
                <li class="mt-[16px] font-[jost] text-[18px] font-[500] text-[#353535] max-lg:text-[18px]">
                    Discounted Price:
                </li>
                <li class="font-[jost] text-[18px] font-[700] text-[#DC275C] max-lg:text-[18px]">
            ...
            <div>
                <div>
                    <h1 class="font-[jost] text-[20px] font-[500] text-[#353535] max-lg:text-[18px]">
                        Payment Options
                    </h1>
                </div>
                <div class="my-[15px] grid w-full grid-cols-2 gap-6 max-xl:grid-cols-1">
                    ...
                    <label class="flex w-full gap-4 border-[2px] border-[#380D37] hover:border-[#380D37]"
                        ...
                        <div class="flex flex-col py-3">
                            <span
                                class="font-[jost] text-[20px] font-[700] text-[#353535] max-lg:text-[18px]">{{ $product->final_price }}৳</span>
                            <span class="font-[jost] text-[16px] font-[400] text-[#353535] max-lg:text-[14px]">Cash
                                Discount Price</span>
                            <span class="font-[jost] text-[16px] font-[400] text-[#353535] max-lg:text-[14px]">Online /
                                Cash Payment</span>
                        </div>
                    </label>
                    ...
                    @if ($month)
                        <label class="flex w-full gap-4 border-[2px] border-[#764A8733] hover:border-[#380D37]"
                            ...
                            <div class="flex cursor-pointer flex-col py-3">
                                ...
                                <span class="font-[jost] text-[16px] font-[400] text-[#353535] max-lg:text-[14px]">0%
                                    EMI
                ...
                <div class="flex gap-[30px]">
                    @if ($product->stock > 0)
                        <button wire:click='checkout("{{ $product->slug }}")'
                            class="fill-up-btn mt-auto rounded-[5px] bg-gradient-to-r from-[#380D37] to-[#DC275C] px-[40px] py-[12px] font-[jost] text-[20px] font-[700] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
                            BUY NOW
                        </button>
                        <button id="{{ $product->id }}"
                            class="add-to-cart fill-up-btn mt-auto rounded-[5px] bg-gradient-to-r from-[#380D37] to-[#DC275C] px-[40px] py-[12px] font-[jost] text-[20px] font-[700] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
                            Add To Cart</button>
                    @else
                        {{-- Mora buttons  --}}
                        <a>
                            <button disabled
                                class="mt-auto cursor-not-allowed rounded-[5px] bg-[#b6b5b5] px-[40px] py-[12px] font-[jost] text-[20px] font-[700] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
                                BUY NOW</button>
                        </a>
                        <button disabled
                            class="mt-auto cursor-not-allowed rounded-[5px] bg-[#b6b5b5] px-[40px] py-[12px] font-[jost] text-[20px] font-[700] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
    ...
    <div class="grid grid-cols-4 gap-10 max-lg:grid-cols-1 max-lg:gap-0">
        <div class="col-span-3">
                    ...
                    <tbody class="mb-[30px] ml-[20px]">
                        ...
                        <tr class="border-b-[2px] border-[#764A8733]">
                            ...
                            <td
                                ...
                                <li class="list-none">L1 Cache: {{ $product->l1_cache ? $product->l1_cache : 'N/A' }}
                                </li>
                                <li class="list-none">L2 Cache: {{ $product->l2_cache ? $product->l2_cache : 'N/A' }}
                                </li>
                                <li class="list-none">L3 Cache: {{ $product->l3_cache ? $product->l3_cache : 'N/A' }}
                                </li>
                            </td>
                        </tr>
                        <tr class="border-b-[2px] border-[#764A8733]">
            ...
            <section class="mt-[20px] rounded-[5px] border-[2px] border-[#380D37] p-[20px] max-sm:border-[1px]"
                id='review'>
