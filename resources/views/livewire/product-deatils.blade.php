        ...
        <div class="text-left max-md:mt-[40px]">
            ...
            <div class="flex text-center gap-[3px] mt-2">
                ...
                <span class="flex items-center">
                    <a href="" class="text-[12px] text-[#000000] hover:text-[#919191] text-center decoration-none duration-200 font-[500]">
                        10 reviews 
                    </a>
                </span>
            </div>
                ...
                <div class="my-[10px] grid w-full grid-cols-2 gap-4 max-xl:grid-cols-1">
                    ...
                    <label class="flex w-full gap-4 border-[2px] border-[#380D37] hover:border-[#380D37]"
                        ...
                        <div class="flex flex-col py-3">
                            ...
                            <span class="font-[jost] text-[14px] font-[400] text-[#353535] max-lg:text-[12px]">Cash
                                Discount Price</span>
                            <span class="font-[jost] text-[14px] font-[400] text-[#353535] max-lg:text-[12px]">Online /
                                Cash Payment</span>
                        </div>
                    </label>
                ...
                <div class="flex gap-[30px] max-sm:gap-[12px] mt-[8px]">
                    @if ($product->stock > 0)
                        ...
                        <button id="{{ $product->id }}"
                            class="add-to-cart fill-up-btn mt-auto rounded-[5px] bg-gradient-to-r from-[#380D37] to-[#DC275C] px-[35px] py-[12px] font-[jost] text-[18px] font-[600] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
                            Add To Cart</button>
                    @else
                        {{-- Mora buttons  --}}
                        <a>
                            <button disabled
                                class="mt-auto cursor-not-allowed rounded-[5px] bg-[#b6b5b5] px-[40px] py-[12px] font-[jost] text-[18px] font-[600] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
                                BUY NOW</button>
                        </a>
                        <button disabled
                            class="mt-auto cursor-not-allowed rounded-[5px] bg-[#b6b5b5] px-[40px] py-[12px] font-[jost] text-[18px] font-[600] text-[#f2f2f2] max-lg:px-[30px] max-lg:py-[14px] max-lg:text-[18px] max-md:px-[30px] max-sm:text-[16px]">
