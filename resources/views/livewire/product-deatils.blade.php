                    ...
                    @if ($month)
                        <label class="flex border-[2px] hover:border-[#380D37] border-[#764A8733] w-full gap-4"
                            ...
                            <div class="flex flex-col py-3 cursor-pointer">
                                ...
                                <span class="text-[16px] max-lg:text-[14px] text-[#353535] font-[jost] font-[400]">0%
                                    EMI
        ...
        <div class="col-span-3">
            ...
            <section
                ...
                <div itemprop="description">
                    ...
                    <p
                        class="text-justify text-[#353535] text-[16px] max-lg:text-[14px] font-[jost] py-[14px] max-sm:py-[10px] font-[500]">
                        {!! $product->summary !!}
                    </p>
                </div>
            </section>
                    ...
                    <div class="">
                        ...
                        <div data-te-modal-init
                            ...
                            <div data-te-modal-dialog-ref
                                class="pointer-events-none relative flex min-h-[calc(100%-1rem)] top-[20px] w-auto translate-y-[-50px] items-center opacity-0 transition-all duration-300 ease-in-out min-[576px]:mx-auto min-[576px]:mt-7 min-[576px]:min-h-[calc(100%-3.5rem)] min-[576px]:max-w-[500px]">
                                <div
