<div
        ...
        <div class="text-left max-md:mt-[40px]">
            ...
            <div class="flex text-center gap-[3px] mt-2">
                ...
                <span class="flex items-center">
                    <a href="#review" class="text-[12px] text-[#000000] hover:text-[#919191] text-center decoration-none duration-200 font-[500] hover:underline">
                        10 reviews
                    </a>
                </span>
            </div>
            <div class="mt-[5px]">
                <p class="font-[jost] text-[16px] font-[500] text-[#353535] max-lg:text-[18px]">Status:<span
                    ...
                    @if ($product->upcomming)
                        <span class="badge badge-success hover:underline">UP COMMING (<span
                    ...
                    @else
                        @if ($product->stock > 0)
                            <span class="badge badge-success hover:underline-offset-3">IN STOCK</span>
                        @else
                            <span class="badge badge-warning hover:underline">OUT OF STOCK</span>
                        @endif
                    @endif
                </span>
            </p>
    ...
    <div class="grid grid-cols-4 gap-10 max-lg:grid-cols-1 max-lg:gap-0">
        <div class="col-span-3">
            ...
            <section class="mt-[20px] scroll-mt-5 rounded-[5px] border-[2px] border-[#380D37] p-[20px] max-sm:border-[1px]"
                id='review'>
