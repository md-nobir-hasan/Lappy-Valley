    ...
    <div class="mt-[30px] grid grid-cols-2 items-center max-md:grid-cols-1">
        ...
        <div class="text-left max-md:mt-[40px]">
            ...
            <div class="flex text-center gap-[3px] mt-2">
                ...
                <span>
                    <a href="" class="text-[12px] text-[#000000] hover:text-[#353535] text-center decoration-none duration-200 font-[500] font-[font-[jost]]">
                        10 reviews 
                    </a>
                </span>
            </div>
        ...
        <div class="overflow-hidden">
          <table class="min-w-full text-center">
            <thead class="border-b">
              <tr>
                <th scope="col" class="font-[jost] text-[16px] font-[400] text-[#353535] max-lg:text-[14px] px-6 py-4">
                   Attributes
                </th>
                <th scope="col" class="font-[jost] text-[16px] font-[400] text-[#353535] max-lg:text-[14px] px-6 py-4">
