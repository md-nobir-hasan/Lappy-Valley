...
<div class='container mx-auto'>
       ...
       <div class='flex gap-[100px] my-[30px]'>
        ...
        <div class='flex gap-[5px] items-center'>
            <img src="/storage/product/mdi_address-marker-outline-black.svg" alt="Product" class='w-[24px] h-[24px]'>
            <span class='text-[#380D37] text-[16px] font-[jost] font-[500] leading-[23.12px]'>Address</span>
        </div>
        <div class='flex gap-[5px] items-center'>
