    <div class="container mx-auto" x-data="dropdown()">
        ...
        <div>
            <div class=" flex gap-[10px] w-[463px] mx-auto">
                ...
                <button type="button"  onclick="reg()"
            ...
            <div
                ...
                <form wire:submit='login' class=" w-full mx-auto mt-[40px}" id='logInForm'>
                    <div>
                        <div class="mb-[15px]">
                            <input wire:model.blur='email'
                                class="italic rounded-[5px] bg-[#F2F2F2] py-[12px] pl-[20px] w-full font-[jost] font-[500]"
                        ...
                        <div class="mb-[20px]">
                            <input wire:model.blur='password'
                                class="italic rounded-[5px] bg-[#F2F2F2] py-[12px] w-full pl-[20px] font-[jost] font-[500]"
                ...
                <form wire:submit='save'
                    class=" w-full  mt-[40px] hidden" id="regForm">
    ...
    <script>
        ...
        var regF = document.getElementById('regForm');
