            ...
            <div
                ...
                <div>
                    ...
                    <div
                        ...
                        <span class='text-[#380D37] h-[19.231px] pr-[5px] flex items-center cursor-pointer text-center'>+</span>
                    </div>
                    <div>
                        <p class='text-[#353535] text-[16px] font-[jost] font-[500] text-center'>1 x <span
                                class='text-[#DC275C]'>{{number_format($cart->product->price)}} TAKA</span></p>
        ...
        <div class='items-center mx-auto w-[364px] translate-y-[360px]'>
            ...
            <div class='my-[30px]'>
                <ul class='flex justify-between mx-[5px]'>
                    ...
                    <li class='text-[20] text-[#DC275C] font-[jost] font-[700]'>{{number_format($carts->sum('amount'))}} TK</li>
                </ul>
            </div>
