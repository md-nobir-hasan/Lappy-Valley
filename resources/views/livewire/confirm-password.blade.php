<div class='container mx-auto'>
    ...
    <form wire:submit='save'>
        <div class='mt-[60px] w-[463px] mx-auto'>
            ...
            <div class='w-[463px] mx-auto border-[2px] border-[#380D37] rounded-[4px] p-[35px]'>
                <div>
                    <p
                        class='w-[full] h-[76px] mx-auto text-[12px] text-[#000000] font-[jost] font-[500] leading-[17.34px]'>
                        A OTP has been sent to your email. Please enter the 6-digit OTP below.</p>
                    <input wire:model='otp'
                        class="italic mt-[10px] mb-[20px] rounded-[5px] bg-[#F2F2F2] py-[12px] text-[16px] text-[#353535] leading-[23.12px] w-full h-[44px] pl-[15px] font-[jost] font-[500]"
