<div class='px-[100px] max-sm:px-[15px] max-lg:px-[45px] max-xl:px-[70px] max-sm:mt-[70px] max-xl:mt-[100px]'>
    ...
    <form wire:submit='save'>
        <div class='mt-[60px] max-2xl:w-[463px] max-sm:w-full mx-auto'>
            <div class='max-2xl:w-[463px] max-sm:w-full mx-auto flex'>
                <a href="#" class="w-full h-[44px] max-sm:h-[35px]"><button
                        class='flex justify-center items-center w-full h-full text-[16px] max-sm:text-[14px] text-[#380D37] focus:text-[#f2f2f2] focus:bg-[#380D37] bg-[#f2f2f2] font-[jost] font-[700] rounded-[4px]'>Log
                        In</button></a>
                <a href="#" class="w-full h-[44px] max-sm:h-[35px]"><button
                        class='flex justify-center items-center w-full h-full text-[16px] max-sm:text-[14px] text-[#380D37] focus:text-[#f2f2f2] focus:bg-[#380D37] bg-[#f2f2f2] font-[jost] font-[700] rounded-[4px]'>Register</button></a>
            </div>
