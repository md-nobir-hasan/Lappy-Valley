    ...
    <div class='mt-[230px] w-[463px] mx-auto'>
        ...
        <div class='w-[463px] mx-auto border-[2px] border-[#380D37] rounded-[4px] p-[35px]'>
            <div>
                ...
                <p
                    class='w-[full] h-[76px] mx-auto text-[16px] text-[#000000] font-[jost] font-[500] leading-[17.34px]'>
                    Did not get the OTP? <span wire:click='resend'>Resend?</span>
                </p>
            </div>
            <div
                class='w-full h-[23px] rounded-[4px] py-[28px] my-[15px] flex justify-center items-center bg-gradient-to-r from-[#380D37] to-[#DC275C]'>
                <a href="#"><button
                        class='w-[full] h-[23px] text-[16px] text-[#FFFFFF] font-[jost] font-[700] leading-[23.12px] '>Register</button></a>
            </div>
