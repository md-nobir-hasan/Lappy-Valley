<div class='container'>
   <div class='p-[30px] border-[3px] border-[#380D37] w-[548px] h-[534px] mx-auto my-[100px] rounded-[4px]'>
      <div class='flex justify-between w-[496px]'>
         <input type="text" placeholder='First Name' class='w-[236px] h-[44px] rounded-[4px] border-[2px] border-[#380D37] italic text-[#000000] text-[12px] font-[jost] font-[400] leading-[17.34px] px-[10px]'>
         <input type="text" placeholder='Last Name' class='w-[236px] h-[44px] rounded-[4px] border-[2px] border-[#380D37] italic text-[#000000] text-[12px] font-[jost] font-[400] leading-[17.34px] px-[10px]'>
      </div>
      <div class='my-[10px]'>
