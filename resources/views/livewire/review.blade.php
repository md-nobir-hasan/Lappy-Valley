{{-- <div class="container mx-auto">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="rounded-[16px] py-4 px-4 bg-[#fff] h-[423px] shadow-[2px_2px_5px_2px_#0000001A]">
                    ...
                    <div>
                        <p
                            class="my-[17px] font-[jost] font-[400] text-[18px] leading-[23.13px] text-left text-[#353535]">
 ...
 <div class="relative mt-[30px] mb-[30px]">
  <div class="relative">
    <div class="swiper-button-next translate-x-[-623px] translate-y-[20px]"></div>
    <div class="swiper-button-prev translate-x-[623px] translate-y-[20px]"></div>
  </div>
    <div class="swiper-pagination sp w-[20px]"></div>
 </div>
