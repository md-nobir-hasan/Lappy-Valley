         ...
         <div class="my-[10px]">
             ...
             <div
                 ...
                 <div class="flex justify-between items-center gap-[50px]">
                     <img class="w-[50px]"
                         src="/storage/{{$cart->product->photo}}"
                         alt="">
     ...
     <table class="flex justify-end">
         <tbody>
             <tr class="border-b-[2px] border-b-[#380D37] gap-[80px] flex py-[12px] pl-[50px] justify-end">
                 ...
                 <td class="text-[20px] text-[#DC275C] font-[jost] font-[00]">{{number_format($cart->sum('amount'))}}৳</td>
             </tr>
             <tr class="border-b-[2px] border-b-[#380D37] gap-[80px] flex py-[12px] pl-[50px] justify-end">
                 <td class="text-[20px] text-[#380D37] font-[jost] font-[600]">Total:</td>
                 <td class="text-[20px] text-[#DC275C] font-[jost] font-[500]">{{number_format($cart->sum('amount'))}}৳</td>
             </tr>
         </tbody>
     </table>
