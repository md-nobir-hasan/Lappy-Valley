<div x-data="{ open: false }">
    ...
    <div class="w-[400px] h-[792px] gap-20 bg-[#F2F2F2] right-0 top-0 fixed z-[9999]" x-show="open">
        ...
        <div
            class="w-[400px] h-[61px] bg-[#380D37] flex justify-between text-[20px] text-[#fff] items-center px-[20px]">
        ...
        <div class=' w-[364px] mx-auto px-[5px]'>
            <div
                ...
                <div class='flex items-center'><img class="w-[80px] h-[px]"
                        src="https://img.ep-cdn.com/i/500/500/al/altgyfzwibuorcempdvx/lenovo-ideapad-1-15amn7-cloud-grey-full-hd-ryzen-3-7320u-8gb-512gb-ssd-82vg0070ya-laptop-cene.jpg"
                        alt=""></div>
                <div>
                    <div>
                        <p class='text-[12px] text-[#380D37] font-[jost] font-[500]'>Lenovo IdeaPad15AMN7 </br> AMD
                            Ryzen 5 7520U 8-512 GB,</br> Brand New Cloud grey</p>
                    </div>
                    <div
                        class='border-[#380D37] w-[85px] h-[19.231px] border-[2px] rounded-[4px] my-[10px] flex items-center justify-around'>
                        <span
                            class='text-[#380D37] h-[19.231px] border-[#380D37] border-r-[2px] pr-[5px] flex items-center'>-</span>
                        <span
                            class='text-[#380D37] h-[19.231px] border-[#380D37] border-r-[2px] pr-[5px] flex items-center'>1</span>
                        <span class='text-[#380D37] h-[19.231px] pr-[5px] flex items-center'>+</span>
                    </div>
                    <div>
                        <p class='text-[#353535] text-[16px] font-[jost] font-[500]'>1 x <span
                                class='text-[#DC275C]'>1,50,000 TAKA</span></p>
