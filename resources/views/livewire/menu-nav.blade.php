...
<!--          
<label for="underline_select" class="sr-only bg-[#f2f2f2]">Underline select</label>
<select id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 
...
<div class="flex">
    ...
    <div id="dropdown-states" class="z-10 hidden bg-white   shadow w-[300px] dark:bg-gray-700">
