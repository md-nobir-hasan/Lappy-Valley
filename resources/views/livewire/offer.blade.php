<div class='container mx-auto'>
    ...
    <!-- -----------------cart---section----1----------- -->
    <div class='grid grid-rows-4 grid-cols-3 max-md:grid-cols-1 max-xl:grid-cols-2 py-[15px] gap-[10px] ml-[100px] max-lg:ml-[0px] max-md:ml-[100px]'>
        <!-- ------------------cart-1----------------- -->
        <div class='bg-[#f2f2f2] rounded-[4px] py-[15px] px-[20px] w-[400px] max-lg:w-[380px] h-[554px] mx-atuo'>
            ...
            <div class='text-center leading-[40px]'>
                ...
                <p class='text-[14px] text-[#380D37] font-[jost] font-[400]'>Pay with Bkash and Enjoy 10% instant
                    Cashback!</p>
            </div>

            <div class='flex justify-center'>
                <button
                    class='text-[#f2f2f2] text-[14px] font-[jost] font-[500] rounded-[4px] bg-gradient-to-r from-[#380D37] to-[#DC275C] py-[10px] px-[21px] flex items-center'>View
                    Details</button>
            </div>
        </div>
        <!-- -----------------------cart-1-end-------------- -->
        <!-- ------------------cart-2----------------- -->
        <div class='bg-[#f2f2f2] rounded-[4px] py-[15px] px-[20px] w-[400px] max-lg:w-[380px] h-[554px]'>
            <div>
                <img class='w-[359px] h-[357px]' src="/storage/product/large-size-laptop.jpg" alt="Product">
            </div>
        ...
        <!-- ------------------cart-3----------------- -->
        <div class='bg-[#f2f2f2] rounded-[4px] items-center py-[15px] px-[20px] w-[400px] max-lg:w-[380px] h-[554px]'>
            <div>
                <img class='w-[359px] h-[357px]' src="/storage/product/large-size-laptop.jpg" alt="Product">
            </div>
