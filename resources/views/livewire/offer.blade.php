<div class='container mx-auto'>
       ...
       <div>
        ...
        <!-- -----------------cart---section----1----------- -->
 <div class='flex justify-around py-[15px]'>
     <!-- ------------------cart-1----------------- -->
     <div class='bg-[#f2f2f2] rounded-[4px] py-[15px] px-[20px] w-[400px] h-[554px]'>
       <div class='rounded-[4px]'>
         <img class='w-[359px] h-[357px]' src="/storage/product/large-size-laptop.jpg" alt="Product">
       </div>
        ...
        <div class='flex justify-between py-[10px]'>
           ...
           <div class='flex justify-center items-center gap-[5px]'>
             ...
             <path d="M15.3 7.50065L15.8 10.0007H4.2L4.7 7.50065H15.3ZM16.6667 3.33398H3.33333V5.00065H16.6667V3.33398ZM16.6667 5.83398H3.33333L2.5 10.0007V11.6673H3.33333V16.6673H11.6667V11.6673H15V16.6673H16.6667V11.6673H17.5V10.0007L16.6667 5.83398ZM5 15.0007V11.6673H10V15.0007H5Z" fill="black"/>
             </svg>
             </div>
             <div>
                <p class='text-[#380D37] text-[12px] font-[jost] font-[400]'>Online</p>
             </div>
           </div>
         </div>
           
          <div class='text-center leading-[40px]'>
            <h1 class='text-[#380D37] text-[20px] font-[jost] font-[500'>Bkash Durga Puja Cashback Offer</h1>
            <p class='text-[14px] text-[#380D37] font-[jost] font-[400]'>Pay with Bkash and Enjoy 10% instant Cashback!</p>
          </div>

          <div class='flex justify-center'>
            <button class='text-[#f2f2f2] text-[14px] font-[jost] font-[500] rounded-[4px] bg-gradient-to-r from-[#380D37] to-[#DC275C] py-[10px] px-[21px] flex items-center'>View Details</button>
          </div>
          </div>
   <!-- -----------------------cart-1-end-------------- -->
   ...
   <!-- -----------------------cart-2-end-------------- -->
      ...
      <!-- ------------------cart-3----------------- -->
      <div class='bg-[#f2f2f2] rounded-[4px] items-center py-[15px] px-[20px] w-[400px] h-[554px]'>
       <div>
         <img class='w-[359px] h-[357px]' src="/storage/product/large-size-laptop.jpg" alt="Product">
       </div>
