<div class="container mx-auto lg:px-16">
    ...
    <section>
        <!-- heading -->
        <div class=" h-[130px] flex justify-center items-center text-white bg-gradient-to-r from-[#DC275C] to-[#764A87]">
            ...
            <div class="rounded-[12px] py-4 px-6 bg-[#fff] w-[280px] h-[306px] shadow-[2px_2px_5px_2px_#0000001A]">
                <div class="flex justify-center">
                    <div class="flex items-center">
                        <img class="rounded-[100%] w-[60px] h-[60px]" src="/storage/product/client-photo.svg" alt="">
                        <div class="ml-2">
                ...
                <div class="rounded-[12px] bg-[#fff] py-4 px-6 w-[398px] h-[398px] items-center  shadow-[2px_2px_5px_2px_#0000001A]">
                    <div class="flex justify-center">
                        <div class="flex items-center">
                            <img class="rounded-[100%] w-[72px] h-[72px]" src="/storage/product/client-photo.svg" alt="">
                            <div class="ml-2">
                        ...
                        <!-- <div class="flex items-center"> -->
                        <div class="flex mt-[40px] ml-auto">
                        <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="#FFA033">
                                <path d="M11 1.8335L13.8325 7.57183L20.1667 8.49766L15.5833 12.9618L16.665 19.2685L11 16.2893L5.335 19.2685L6.41667 12.9618L1.83334 8.49766L8.1675 7.57183L11 1.8335Z" fill="#FFA033" stroke="#FFA033" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg></a>
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="#FFA033">
                                <path d="M11 1.8335L13.8325 7.57183L20.1667 8.49766L15.5833 12.9618L16.665 19.2685L11 16.2893L5.335 19.2685L6.41667 12.9618L1.83334 8.49766L8.1675 7.57183L11 1.8335Z" fill="#FFA033" stroke="#FFA033" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 15 15" fill="none">
                                <path d="M7.5 1.25L9.43125 5.1625L13.75 5.79375L10.625 8.8375L11.3625 13.1375L7.5 11.1062L3.6375 13.1375L4.375 8.8375L1.25 5.79375L5.56875 5.1625L7.5 1.25Z" stroke="#FFA033" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg></a>
                        </div>
                        <!-- </div> -->
                    ...
                    <div class="rounded-[12px] py-4 px-6 bg-[#fff] w-[280px] h-[306px] shadow-[2px_2px_5px_2px_#0000001A]">
                        ...
                        <path d="M22.5 9L13.5 18L22.5 27" stroke="#353535" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </div>
                        ...
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                        <path d="M13.5 27L22.5 18L13.5 9" stroke="#353535" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </div>
                        </div>
            ...
            <section class="mt-16 mb-5">
                ...
                <div class="grid grid-cols-2 mt-20">
                    ...
                    <form>
                        ...
                        <div>
                            <textarea class="h-[271px] rounded-[4px] w-full py-2 pb-32 px-3 bg-[#F2F2F2] font-[jost] text-[16px]  italic font-[500] " id="message"
