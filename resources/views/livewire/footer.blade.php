      ...
      <div class="flex justify-evenly max-sm:block max-sm:px-[18px]">
          ...
          <div>
              ...
              <div
                  ...
                  <a href="{{$other_setting->fb}}" title="Facebook"
                  ...
                  <a href="{{$other_setting->twitter}}" title="Twitter" class="hover:bg-blue-400 w-[25.08px] h-[24px] flex justify-center items-center">
                  ...
                  <a href="{{$other_setting->youtube}}" title="Youtube"
                  ...
                  <a href="{{ $other_setting->email }}" title="E-mail"
                      class="rounded-[20%] hover:bg-blue-400 w-[25.08px] h-[24px] flex justify-center items-center">
