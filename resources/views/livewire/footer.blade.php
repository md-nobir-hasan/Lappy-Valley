      ...
      <div class="flex justify-evenly max-sm:block max-sm:px-[18px]">
          ...
          <div>
              ...
              <ul
                  ...
                  <li class="mt-[15px]">
                      <span class="px-1 hover:bg-blue-700">
                          Map Link : <a href="https://maps.app.goo.gl/Vv61kHPXdfG5ykA56" target="_blank">In Uttra (Dhaka)</a>
                      </span>
                  </li>
                  <li>
                      <span class="px-1 hover:bg-blue-700">
                        Map Link: <a href="https://maps.app.goo.gl/UEBP1XWufz1RkdjK7" target="_blank">In Jamuna Future Park (Dhaka)</a>
                      </span>
                  </li>
              </ul>
