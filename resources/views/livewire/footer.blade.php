  <footer
      ...
      <div class="flex justify-evenly max-sm:block max-sm:px-[18px]">
          ...
          <div>
              ...
              <!-- -------social----------icon------------- -->
              <div class="mt-[20px] flex max-sm:justify-center max-sm:items-center gap-4 text-[24px] max-sm:pb-[100px] max-sm:pt-[20px]">
                  ...
                  <a href="{{$other_setting->instagram}}"
                  ...
                  <a href="{{$other_setting->youtube}}" class="rounded-[20%] hover:bg-blue-400 w-[25.08px] h-[24px] flex justify-center items-center">
