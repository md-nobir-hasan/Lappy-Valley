  <footer
      ...
      <div class="flex justify-evenly max-sm:block max-sm:px-[18px]">
          ...
          <div>
              ...
              <!-- -------social----------icon------------- -->
              <div class="mt-[20px] flex gap-2 max-sm:ml-[80px] text-[24px] max-sm:pb-[100px] max-sm:pt-[20px]">
                  <a href="#"
                      class="bg-[#f2f2f2] rounded-[100%] hover:bg-blue-400 w-[30px] h-[30px] flex justify-center items-center">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" id="twitter"
                          ...
                          <g fill="#DC275C">
                              {{-- <path d="M30 2v28H2V2h28m1-1H1v30h30V1z"></path>
                                <path d="M30 2v28H2V2h28m1-1H1v30h30V1z"></path> --}}
                              <path
                                  d="M18.141 9.16c-1.529.556-2.495 1.991-2.385 3.562l.037.606-.612-.074c-2.226-.284-4.171-1.249-5.823-2.869L8.55 9.58l-.208.594c-.44 1.323-.159 2.721.758 3.661.489.52.379.594-.465.284-.294-.099-.55-.173-.575-.136-.085.087.208 1.212.44 1.657.318.619.966 1.224 1.676 1.583l.6.284-.709.012c-.685 0-.709.012-.636.273.245.804 1.211 1.657 2.287 2.029l.758.259-.66.396a6.855 6.855 0 0 1-3.278.915c-.551.012-1.004.062-1.004.099 0 .123 1.493.816 2.361 1.088 2.605.804 5.701.457 8.025-.915 1.651-.977 3.302-2.919 4.074-4.799.416-1.001.832-2.832.832-3.709 0-.569.037-.643.722-1.323.404-.396.783-.828.856-.952.123-.235.11-.235-.514-.025-1.04.371-1.187.322-.673-.235.379-.396.832-1.113.832-1.323 0-.037-.183.025-.392.136-.22.124-.709.309-1.076.42l-.66.211-.6-.409c-.33-.222-.795-.47-1.04-.544-.623-.173-1.578-.149-2.14.049z">
                              </path>
                          </g>
                      </svg>
                  </a>
                  <a href="#"
                      class="bg-[#f2f2f2] rounded-[10%] hover:bg-blue-400 w-[30px] h-[30px] flex justify-center items-center">
                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="instagram"><g data-name="Brand Logos">
                        <path fill="#DC275C" d="M12.00039,6.86511A5.13489,5.13489,0,1,0,17.13528,12,5.13479,5.13479,0,0,0,12.00039,6.86511Zm0,8.46846A3.3336,3.3336,0,1,1,15.334,12,3.33317,3.33317,0,0,1,12.00039,15.33357Z"></path>
                        ...
                        <path fill="#6563ff" d="M17.339,5.462h-.00044a1.19979,1.19979,0,1,0,.00044,0Z"></path></g></svg>
                  </a>
                  <a href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="25.08" height="24"
                          ...
                          viewBox="0 0 26 24" fill="#F2F2F2">
                          <path
                              d="M24.84 9.70998C24.8917 8.27864 24.5646 6.858 23.8891 5.57998C23.4307 5.05558 22.7946 4.70169 22.0917 4.57998C19.184 4.32751 16.2642 4.22403 13.345 4.26998C10.4364 4.22194 7.52718 4.32208 4.6297 4.56998C4.05685 4.6697 3.52672 4.92683 3.104 5.30998C2.1635 6.13998 2.059 7.55998 1.9545 8.75998C1.80289 10.9175 1.80289 13.0824 1.9545 15.24C1.98473 15.9154 2.08982 16.5858 2.268 17.24C2.394 17.745 2.64893 18.2123 3.00995 18.6C3.43555 19.0034 3.97802 19.2752 4.567 19.38C6.81993 19.6461 9.08999 19.7564 11.3595 19.71C15.017 19.76 18.2252 19.71 22.0185 19.43C22.6219 19.3316 23.1797 19.0595 23.6174 18.65C23.9099 18.3699 24.1284 18.0271 24.2548 17.65C24.6285 16.5526 24.8121 15.4041 24.7982 14.25C24.84 13.69 24.84 10.31 24.84 9.70998ZM10.9833 14.85V8.65998L17.1697 11.77C15.435 12.69 13.1465 13.73 10.9833 14.85Z"
                              fill="#F2F2F2" />
                      </svg></a>
                  <a href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="25.08" height="24"
