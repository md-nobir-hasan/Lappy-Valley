<div class="container mx-auto">
    ...
    <form action="{{route('password.email')}}" method="POST">
        @csrf
        <div class=" w-[463px] h-[336px] mx-auto mt-[40px] p-[px]">
            <div class="border-[2px] border-[#380D37] rounded-[4px] left-[70px] pt-[33px] pb-[20px] pl-[65px] pr-[50px]">
                <div class="mb-[40px] mt-[10px]">
                    <span class="font-[jost] font-[600] text-[#380D37] w-[181.56px] h-[29.25px] text-[20px] my-[15px]">Reset Password</span>
                </div>
    ...
    <!--Sign in button-->
    <div class='h-[2px] bg-[#764A8733] mt-[100px]'></div>
</div>
