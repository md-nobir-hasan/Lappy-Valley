    ...
    <div class="mb-[40px] mt-[10px]">
      <span class="font-[jost] font-[600] text-[#380D37] text-[18px] my-[15px]">Reset Password</span>
        ...
        <div class="mb-[20px] w-full">
          <input class="italic rounded-[5px] bg-[#F2F2F2] py-[14px] pl-[15px] w-full font-[jost] font-[500]" type="email" placeholder="New Password">
        </div>
        <div class="mb-[20px] w-full">
            <input class="italic rounded-[5px] bg-[#F2F2F2] py-[14px] pl-[15px] w-full font-[jost] font-[500]" type="email" placeholder="Confirm Password">
          </div>
   <div class="my-[20px] w-full">
    <button class=" w-full font-[jost] font-[500] text-[18px] text-[#fff] bg-gradient-to-r from-[#380D37] to-[#DC275C] py-[18px] rounded-[5px]">Change Password</button>
   </div>
  </div>
  </div>
  <!--Sign in button-->
