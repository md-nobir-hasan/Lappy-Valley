       ...
       <div class='flex gap-[5px] items-center'><img src="/storage/product/vector-1.svg" alt="Product" class='w-[16px] h-[14px]'><span class='text-[16px] text-[#380D37] font-[jost] font-[400] leading-[23.12px]'>Log Out</span></div>
        ...
        <div class='h-[2px] bg-[#764A8733]'></div>
            ...
            <div  class='flex items-center gap-[5px] translate-x-[370px] mt-[50px] mb-[30px]'>
                ...
                <path d="M37 6.16602C19.9707 6.16602 6.16663 19.9701 6.16663 36.9993C6.16663 54.0286 19.9707 67.8327 37 67.8327C54.0292 67.8327 67.8333 54.0286 67.8333 36.9993C67.8333 19.9701 54.0292 6.16602 37 6.16602Z" stroke="black" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M13.1688 56.5668C13.1688 56.5668 20.0416 47.7917 36.9999 47.7917C53.9582 47.7917 60.8341 56.5668 60.8341 56.5668M36.9999 37C39.4532 37 41.8059 36.0254 43.5406 34.2907C45.2754 32.556 46.2499 30.2033 46.2499 27.75C46.2499 25.2967 45.2754 22.944 43.5406 21.2093C41.8059 19.4746 39.4532 18.5 36.9999 18.5C34.5467 18.5 32.1939 19.4746 30.4592 21.2093C28.7245 22.944 27.7499 25.2967 27.7499 27.75C27.7499 30.2033 28.7245 32.556 30.4592 34.2907C32.1939 36.0254 34.5467 37 36.9999 37Z" stroke="black" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
                </div>
                <div>
                        ...
                        <div class='items-center'>
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <g clip-path="url(#clip0_1033_2009)">
                                <path d="M12 21.3432L2.53719 12.7718C-2.60567 7.62895 4.95433 -2.24533 12 5.74324C19.0458 -2.24533 26.5715 7.66324 21.4629 12.7718L12 21.3432Z" stroke="#F2F2F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
