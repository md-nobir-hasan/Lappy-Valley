<div class='container mx-auto max-sm:mt-[70px] max-xl:mt-[100px]'>
    ...
    <div class='grid grid-cols-5 gap-[20px] max-sm:grid-cols-2 max-lg:grid-cols-3 max-lg:w-[520px] w-[1000px] my-[30px]'>
    ...
    <div class='h-[2px] bg-[#764A8733]'></div>
    <div class='flex flex-col max-lg:border-[2px] max-lg:border-[#353535] max-sm:w-[320px] max-lg:w-[420px] max-lg:mx-auto max-lg:py-[20px] max-lg:pl-[40px] max-sm:pl-[30px] max-lg:rounded-[4px] mt-[20px] gap-[20px]'>
        ...
        <div class=''>
            ...
            <div class=''>
                ...
                <input type="text" placeholder='Old Password'
                    class='w-[344px] max-sm:w-[260px] h-[44px] bg-[#F2F2F2] font-[jost] font-[500] text-[16px] text-[#353535] block italic px-[10px] rounded-[4px]'>
            </div>
            <div class=''>
                <label for="address"
                ...
                <input type="text" placeholder='New Password'
                    class='w-[344px] max-sm:w-[260px] h-[44px] bg-[#F2F2F2] font-[jost] font-[500] text-[16px] text-[#353535] blcok italic px-[10px] rounded-[4px]'>
            </div>
            <div class=''>
                <label for="address"
            ...
            <div class='flex max-lg:justify-center items-center'>
                <button
                    class='w-[133px] max-sm:w-[115px] max-sm:h-[35px] h-[41px] rounded-[4px] text-[#F2F2F2] text-[14px] font-[jost] font-[500] leading-[20.23px] bg-gradient-to-r from-[#380D37] to-[#DC275C]'>Save
                    Changes</button>
            </div>
    </div>
