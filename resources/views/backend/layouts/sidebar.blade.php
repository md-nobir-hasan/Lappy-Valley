<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" target="_nobir" wire:navigate href="{{ route('home') }}">
    ...
    <li class="nav-item {{ request()->routeIs('category.*') ? 'active' : '' }}">
        <a class="nav-link  {{ request()->routeIs('category.*') ? '' : 'collapsed' }}" href="#"
            data-toggle="collapse" data-target="#categoryCollapse" aria-expanded="true"
            aria-controls="categoryCollapse">
            <i class="fas fa-sitemap"></i>
            <span>Category</span>
        </a>
        <div id="categoryCollapse" class="collapse  {{ request()->routeIs('category.*') ? 'show' : '' }}"
