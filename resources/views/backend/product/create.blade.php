                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="p_brand" type="text" name="p_brand" placeholder="Exp:- 2.8 GHz upto 4.3 GHz"
                                value="{{ old('p_brand') }}" class="form-control" required>
                            @error('p_brand')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="c_speed" type="text" name="c_speed" placeholder="Exp:- 2.8 GHz upto 4.3 GHz"
                                value="{{ old('c_speed') }}" class="form-control" required>
                            @error('c_speed')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="l1_cache" type="text" name="l1_cache" placeholder="Exp:- 256 KB"
                                value="{{ old('l1_cache') }}" class="form-control" required>
                            @error('l1_cache')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="l2_cache" type="text" name="l2_cache" placeholder="Exp:- 2 MB"
                                value="{{ old('l2_cache') }}" class="form-control" required>
                            @error('l2_cache')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="l3_cache" type="text" name="l3_cache" placeholder="Exp:- 4 MB"
                                value="{{ old('l3_cache') }}" class="form-control" required>
                            @error('l3_cache')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="d_resolution" type="text" name="d_resolution" placeholder="Exp:- 1920 x 1080"
                                value="{{ old('d_resolution') }}" class="form-control" required>
                            @error('d_resolution')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="k_type" type="text" name="k_type" placeholder="Exp:- Standard"
                                value="{{ old('k_type') }}" class="form-control" required>
                            @error('k_type')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="webcam" type="text" name="webcam" placeholder="Exp:- Yes"
                                value="{{ old('webcam') ?? 'Yes' }}" class="form-control" required>
                            @error('webcam')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="microphone" type="text" name="microphone" placeholder="Exp:- Yes"
                                value="{{ old('microphone') ?? 'Yes' }}" class="form-control" required>
                            @error('microphone')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="speaker" type="text" name="speaker" placeholder="Exp:- Yes"
                                value="{{ old('speaker') ?? 'Yes' }}" class="form-control" required>
                            @error('speaker')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="headphone_p" type="text" name="headphone_p" placeholder="Exp:- 1x Headphone"
                                required value="{{ old('headphone_p') }}" class="form-control">
                            @error('headphone_p')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="form-group">
                            ...
                            <input id="bluetooth" type="text" name="bluetooth" placeholder="Exp:- Bluetooth 5.0"
                                required value="{{ old('bluetooth') }}" class="form-control">
                            @error('bluetooth')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
