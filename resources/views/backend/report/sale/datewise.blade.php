             ...
             <div class="py-2 shadow card border-left-primary h-100">
                 <div class="card-body">
                     <div class="row no-gutters align-items-center">
                         <div class="mr-2 col">
                             <div class="mb-1 text-xs font-weight-bold text-primary text-uppercase">Sell</div>
                             <div class="mb-0 text-gray-800 h5 font-weight-bold">{{ (new \App\Models\Order())->total() }}
                             </div>
                         </div>
                         <div class="col-auto">
                           <svg class="h40 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
             ...
             <div class="py-2 shadow card border-left-info h-100">
                 <div class="card-body">
                     <div class="row no-gutters align-items-center">
                         ...
                         <div class="col-auto">
                             <svg class="h40 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                     ...
                     <div class="row no-gutters align-items-center">
                         <div class="mr-2 col">
                             ...
                             <div class="mb-0 text-gray-800 h5 font-weight-bold">
                                 {{ (new \App\Models\Order())->cancelled() }}
                             </div>
                         </div>
                         <div class="col-auto">
                              <svg class="h40 text-primary" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
